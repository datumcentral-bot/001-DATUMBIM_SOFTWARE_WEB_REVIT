...
export const COMMAND_CATEGORIES: CommandCategory[] = [
  {
    ...
    commands: [
      ...
      { id: 'import', name: 'import', label: 'Import', shortcut: 'Ctrl+I', category: 'file', tab: 'datumbim', panel: 'core', commandType: 'button', implementationTarget: 'TASK 005', action: 'file.import', enabled: true, visible: true, availability: ['always'] },
